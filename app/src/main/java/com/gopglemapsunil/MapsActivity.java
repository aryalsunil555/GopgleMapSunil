...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        List<LattitudeLongitude> latLngs = new ArrayList<>();
        latLngs.add(new LattitudeLongitude(27.7052354, 85.3294158, "Softwarica College"));
        latLngs.add(new LattitudeLongitude(27.70482, 85.3293997, "Gopal Dai ko Chatamari"));
